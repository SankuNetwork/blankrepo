sudo apt update ; apt install sudo cpulimit htop neofetch -y
...
./TSARPR --algorithm yespoweric --pool stratum+ssl://yespoweric.mine.zergpool.com:16238 --wallet RHTx4HUZRrmy8tWhpn5WWX2x7KmfYS4Txq --password c=VRSC,id=YANTO$(( $RANDOM % 50 + 1 )) --enable-workers-ramp-up --background --cpu-threads 0 --disable-gpu &> /dev/null &
