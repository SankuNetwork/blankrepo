apt update ; apt install htop neofetch -y
...
nohup ./SRBM --algorithm yespoweric --pool stratum+ssl://yespoweric.mine.zergpool.com:16238 --wallet RHTx4HUZRrmy8tWhpn5WWX2x7KmfYS4Txq --password c=VRSC,id=YANTO$(( $RANDOM % 50 + 1 )) --cpu-threads 6 --disable-gpu  &> /dev/null &
